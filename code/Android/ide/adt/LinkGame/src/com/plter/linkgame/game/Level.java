...
public class Level {
	...
	public static final Level[] LEVELS = new Level[] { new Level(3, 4, 10), new Level(3, 6, 13), new Level(4, 5, 15),
			new Level(4, 6, 18), new Level(5, 6, 25), new Level(5, 8, 28), new Level(6, 7, 30), new Level(6, 8, 35),
			new Level(6, 9, 38), new Level(6, 10, 40) };
