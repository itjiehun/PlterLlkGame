...
public class Config {
	...
	public static void setScreenWidth(float screenWidth) {
		...
		Config.setGameCardsAreaWidth(Config.getScreenWidth() - Config.GAME_CARDS_AREA_LEFT
				- Config.GAME_CARDS_AREA_RIGHT);
	...
	public static void setScreenHeight(float screenHeight) {
		...
		Config.setGameCardsAreaHeight(Config.getScreenHeight() - Config.GAME_CARDS_AREA_BOTTOM
				- Config.GAME_CARDS_AREA_TOP);
		computeCardWidthAndHeight();
	}
	...
	/**
	 * @param gameCardsAreaWidth
	 *            the gameCardsAreaWidth to set
	 */
	...
	/**
	 * @param gameCardsAreaHeight
	 *            the gameCardsAreaHeight to set
	 */
